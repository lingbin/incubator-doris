...
# bossdk 
BOSSDK_DOWNLOAD="http://sdk.bce.baidu.com/console-sdk/bce-sdk-c++-0.8.2.tar.gz"
BOSSDK_NAME="bce-sdk-c++-0.8.2.tar.gz"
BOSSDK_SOURCE="cppsdk"
BOSSDK_MD5SUM="84d3c41bc5a8e245068d8ea3c723ecc7"

# libuuid 
UUIDLIB_DOWNLOAD="http://nchc.dl.sourceforge.net/project/libuuid/libuuid-1.0.3.tar.gz"
UUIDLIB_NAME="libuuid-1.0.3.tar.gz"
UUIDLIB_SOURCE="libuuid-1.0.3"
UUIDLIB_MD5SUM="d44d866d06286c08ba0846aba1086d68"

# all thirdparties which need to be downloaded is set in array TP_ARCHIVES
export TP_ARCHIVES="LIBEVENT OPENSSL THRIFT LLVM CLANG COMPILER_RT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP LZO2 CURL RE2 BOOST MYSQL BOOST_FOR_MYSQL LEVELDB BRPC ROCKSDB LIBRDKAFKA FLATBUFFERS ARROW BROTLI DOUBLE_CONVERSION ZSTD S2 BITSHUFFLE CROARINGBITMAP ORC JEMALLOC BOSSDK UUIDLIB" 
