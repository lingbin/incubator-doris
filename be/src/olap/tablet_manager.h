...
private:
    ...
    struct TableInstances {
        ...
        // The first element(i.e. tablet_arr[0]) is the base tablet. When we add new tablet to
        // tablet_arr, we will sort all the elements in create-time ascending order, which will
        // ensure the first one is base-tablet
